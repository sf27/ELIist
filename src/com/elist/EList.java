...
public class EList<T> {
    ...
    public EList<T> addFirst(T datoR) {
        if (isEmpty()) {
            ...
            // nuevo.enlace = primerNodo;//se enlaza el nuevo nodo con el primer
            // nodo
            primerNodo = nuevo;// el primer nodo pasa a ser igual al ultimo
                               // nuevo
        }// else
        return this;
    }// addFirst
    ...
    public EList<T> addLast(T datoR) {
        if (isEmpty()) {
            ...
            // nota: el primer nodo no pasa a ser el igual al ultimo, se deja el
            // nuevo de ultimo.
        }// else
        return this;
    }// addLast
    ...
    /**
     * Metodo que modifica el valor ubicado en la posicion indicada con el valor
    ...
    /**
     * Metodo que elimina todos los datos de la lista Retorna true si se realizo
     * correctamente el proceso, false en caso contrario
     * 
     * @return boolean
     */
    public boolean clear() {
        boolean aux = false;
        if (!isEmpty()) {
            // se hace null el primerNodo para que la maquina virtual se
            // encargue de liberar el espacio de memoria
            primerNodo = null;
            aux = true;
        }// if
        return aux;
    ...
    /**
     * Metodo que elimina un dato de la lista almacenado en la posicion
     * especificada, en caso de encontrarse en ella. Sino arroja una exception
            ...
            while (nodoR != primerNodo || !auxB) {
                ...
                if (i == index) {
                    ...
                    if (nodoR.getEnlace() == nodoR) {
                        primerNodo = null;
                        break;// es obligatorio salir del bucle, sino entra en
                              // un bucle infinito
                    }// if
                    else {
    ...
    /**
     * Metodo que elimina el dato recibido de la lista, en caso de encontrarse
    ...
    /**
     * Metodo que copia los datos de la lista a un arreglo tipo Object el cual
     * es retornado
     * 
     * @return Object[]
     */
    ...
    public static void main(String[] args) {
        ...
        // primerNodo.enlace.enlace.enlace.enlace.dato);
        // System.out.println("asss  " +
        // primerNodo.enlace.enlace.enlace.enlace.enlace.dato);
        // System.out.println("assss " +
        // primerNodo.enlace.enlace.enlace.enlace.enlace.enlace.dato);
    }
}// CLASS
